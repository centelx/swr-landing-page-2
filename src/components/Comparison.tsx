    ...
    <section className="py-24 px-4 bg-brand-navy relative overflow-hidden">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 relative z-10">
          {/* TANIA STRONA */}
          <div className="bg-gray-900/50 border border-gray-800 p-8 rounded-2xl opacity-60">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 text-gray-500">
                <X className="w-5 h-5 text-red-500 flex-shrink-0 mt-1" />
                <span>Nikt nie dba o psychologię sprzedaży – ma tylko "ładnie wyglądać".</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-gray-800 border-2 border-brand-neon p-8 rounded-2xl shadow-2xl shadow-brand-neon/5 relative">
            <div className="absolute -top-4 right-6 bg-brand-neon text-black text-xs font-black px-3 py-1 rounded">
                MODEL PREMIUM
            </div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-gray-200">
                ...
                <span>**Bierzemy wszystko na siebie.** My piszemy teksty marketingowe za Ciebie.</span>
              </li>
              <li className="flex items-start gap-3 text-gray-200">
                <Check className="w-5 h-5 text-brand-neon flex-shrink-0 mt-1" />
        ...
        {/* Mały banner "Święty Spokój" */}
        <motion.div 
            whileInView={{ opacity: 1, scale: 1 }}
            initial={{ opacity: 0, scale: 0.9 }}
            className="mt-12 bg-gradient-to-r from-brand-navy to-brand-dark border border-brand-neon/20 p-6 rounded-xl flex flex-col md:flex-row items-center justify-between gap-6"
        >
            <div className="flex items-center gap-4 text-left">
                ...
                <div>
                    <h4 className="text-white font-bold">Gwarancja Świętego Spokoju</h4>
            ...
            <div className="flex items-center gap-4 text-left">
                ...
                <div>
                    <h4 className="text-white font-bold">Zero Twojej Pracy</h4>
                    <p className="text-gray-400 text-sm">Nie potrzebujemy od Ciebie tekstów ani zdjęć – my je stworzymy.</p>
                </div>
            </div>
        </motion.div>
