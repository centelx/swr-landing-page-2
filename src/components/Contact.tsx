                                    ...
                                    >
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <input
                                                ...
                                                onChange={handleInputChange}
                                                className={`w-full p-4 bg-gray-800 border rounded-lg text-white focus:border-brand-neon outline-none ${formData.contactMethod === 'Telefon' ? 'border-brand-neon/50' : 'border-gray-700'
                                                    }`}
                                            />
                                            ...
                                            <input
                                                ...
                                                onChange={handleInputChange}
                                                className={`w-full p-4 bg-gray-800 border rounded-lg text-white focus:border-brand-neon outline-none ${formData.contactMethod === 'Email' ? 'border-brand-neon/50' : 'border-gray-700'
                                                    }`}
                                            />
